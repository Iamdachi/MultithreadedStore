...
public class Analytics {
     ...
     */
    public static Report generateReport(List<Order> processed, List<Order> reservedOrders, List<Order> cancelledOrders, Map<Product, Integer> maxReservedByProduct) {
